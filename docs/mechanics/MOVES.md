...

{
  ...
  "Turnbuckle": {
    ...
    "Flying Attack": {
      "Standing Opponent Flying Attack": {
        ...
        "Moves": {
          "Release C-Down": "Standing Opponent Flying Attack"
        }
      },
      "Standing Opponent Flying Attack to Outside": {
        ...
        "Setup": "D-Pad plus run (C-Down) into turnbuckle, release C-Down to jump off",
        "Moves": {
          "Release C-Down": "Standing Opponent Flying Attack to Outside"
        }
      },
      "Standing Opponent Flying Finisher": {
        "Opponent State": "Standing In or Outside of Ring",
        "Setup": "With Special, D-Pad plus run (C-Down) into turnbuckle, release C-Down to jump off",
        "Moves": {
          "Release C-Down (With Special)": "Standing Opponent Flying Finisher"
        }
      },
      "Laying Opponent Flying Attack": {
        ...
        "Setup": "D-Pad plus run (C-Down) into turnbuckle, release C-Down to jump off",
        "Moves": {
          "Release C-Down": "Laying Opponent Flying Attack"
        }
      },
      "Laying Opponent Flying Attack to Outside": {
        ...
        "Setup": "D-Pad plus run (C-Down) into turnbuckle, release C-Down to jump off",
        "Moves": {
          "Release C-Down": "Laying Opponent Flying Attack to Outside"
        }
      },
      "Laying Opponent Flying Finisher": {
        ...
        "Setup": "With Special, D-Pad plus run (C-Down) into turnbuckle, release C-Down to jump off",
        "Moves": {
          "Release C-Down (With Special)": "Laying Opponent Flying Finisher"
        }
      },
      "Turnbuckle Inside Attack (Bret's Rope Attack)": {
        "Opponent State": "Laying Down Inside Ring Near Corner",
        "Setup": "In corner press D-Pad towards corner while pressing A",
        "Moves": {
    ...
    "Turnbuckle Taunt": {
      ...
      "Moves": {
        "Control Stick": "Top Turnbuckle Taunt"
      }
    }
  },
  "Ringside": {
    "Grapple to Apron": {
      "Weak Grapple to Apron": {
        "Opponent State": "Standing on Apron",
        "Setup": "From inside ring, initiate weak grapple to opponent standing on apron",
        "Moves": {
          "A or B": "Weak Grapple to Apron"
        }
      },
      "Strong Grapple to Apron": {
        "Opponent State": "Standing on Apron",
        "Setup": "From inside ring, initiate strong grapple to opponent standing on apron",
        "Moves": {
  ...
  "Apron": {
    ...
    "Grapple From Apron": {
      "Weak Grapple from Apron": {
        ...
        "Setup": "Initiate weak grapple to opponent in ring while standing on ring apron",
        "Moves": {
      ...
      "Strong Grapple from Apron": {
        "Opponent State": "Standing inside ring near ropes",
        "Setup": "Initiate strong grapple to opponent in ring while standing on ring apron",
        "Moves": {
    ...
    "Counter Grapple from Apron": {
      "Opponent State": "Grappling player on ring apron while standing inside ring",
    ...
    "Flying Attack to Ring": {
      "Flying Attack to Ring (Standing Opponent)": {
        "Opponent State": "Standing Inside Ring",
        "Setup": "Standing on Ring Apron",
        "Moves": {
          "A": "Flying Attack (Standing Opponent)"
        }
      },
      "Flying Attack to Ring (Laying Opponent)": {
        "Opponent State": "Laying Inside Ring",
        "Setup": "Standing on Ring Apron",
        "Moves": {
      ...
      "Flying Attack to Ring (Special)": {
        "Opponent State": "Standing or Laying Inside Ring",
        "Setup": "Standing on Ring Apron, with Special",
        "Moves": {
          "A (With Special)": "Flying Attack (Special)"
        }
      }
    },
    "Apron Taunt": {
  ...
  "Irish Whip": {
    "Irish Whip Attack (Strike)": {
      "Opponent State": "Running Towards Opponent",
      "Setup": "Standing",
      "Moves": {
        "B": "Irish Whip Attack"
      }
    ...
    "Irish Whip Grapple": {
      "Irish Whip Grapple (Weak)": {
        ...
        "Setup": "Standing, opponent running towards player",
        "Moves": {
  ...
  "Taunt": {
    "Taunt": {
      ...
      "Moves": {
        ...
        "Control Stick Left": "Standing Taunt 2",
  ...
  "Double-Team": {
    "Double-Team Grapple": {
      "Standing Double Team Grapple": {
        ...
        "Moves": {
          "A (Front)": "Front Double-Team Grapple",
          "A (Back)": "Back Double-Team Grapple",
          "A (Sandwich)": "Sandwich Double-Team Grapple"
        }
      },
    ...
    "Double Team Flying Attack": {
      ...
      "Moves": {
        "From Top Rope Into Ring": "Double Team Flying Attack (Top Rope)",
        "From Top Rope Outside": "Double Team Flying Attack (Top Rope to Outside)",
        "From Apron": "Double Team Flying Attack (Apron)"
      }
    }
  }
}
...
| Falling Neck Breaker               | D     | FALSE | FALSE | null    |
...
| Powerbomb Pin 01                   | C     | FALSE | FALSE | null    |
| Powerbomb Pin 02                   | C     | FALSE | FALSE | null    |
| Powerbomb Pin 03                   | B     | FALSE | FALSE | null    |
| Powerbomb Pin 04                   | B     | FALSE | FALSE | null    |
| Powerbomb Pin 05                   | C     | FALSE | FALSE | null    |
| Powerbomb Pin 06                   | B     | FALSE | FALSE | null    |
| Powerbomb Pin 07                   | C     | FALSE | FALSE | null    |
| Powerbomb Pin 08                   | C     | FALSE | FALSE | null    |
| Powerbomb Pin 09                   | C     | FALSE | FALSE | null    |
...
| Strong Sambo Suplex                | C     | FALSE | FALSE | null    |
